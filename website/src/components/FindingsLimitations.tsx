...
export const FindingsLimitations: React.FC = () => {
  ...
  return (
    <section id="findings" className="py-20 border-b border-slate-850 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">
              Analytical Findings & Project Limitations
            </h2>
          </div>
          <p className="mt-3 md:mt-0 text-sm text-slate-400 max-w-md">
            Distinguishing verified empirical results from commercial interpretations, alongside honest data constraints.
          </p>
        </div>
        ...
        {/* Limitations Section */}
        <div id="limitations" className="pt-8">
          ...
          <h3 className="text-2xl font-bold text-white mb-8">Project Limitations</h3>
